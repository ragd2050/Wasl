...
(function (global) {
  ...
  async function request(path, options) {
    ...
    try {
      ...
      offline.error_ar = isLocalHost
        ? "محرك الذكاء الاصطناعي غير مشغّل. يجب إغلاق Live Server، ثم تشغيل START-WASL.bat وفتح الموقع من العنوان 127.0.0.1:8080. التسجيلات ما زالت محفوظة."
  ...
  async function prepareAndUpload(assessmentId) {
    ...
    if (missingTasks.length) {
      ...
      incompletePlan.error_ar = "لم تكتمل جميع عينات خطة التقييم. يُرجى العودة إلى صفحة التسجيل واستكمال المهام.";
    ...
    for (var index = 0; index < tasks.length; index += 1) {
      ...
      if (!recording || !recording.blob) {
        ...
        incomplete.error_ar = "أحد التسجيلات المطلوبة غير موجود. يُرجى العودة إلى صفحة التسجيل واستكمال العينة.";
