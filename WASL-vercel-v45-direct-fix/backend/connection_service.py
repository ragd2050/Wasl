...
ERRORS = {
    ...
    "CLINICAL_SELECTION_REQUIRED": ("يجب على الأخصائي تحديد الأولوية ومسار التوجيه.", "The specialist must select a priority and clinical pathway."),
    "CLINICAL_NOTE_REQUIRED": ("يجب إضافة ملاحظة مهنية تشرح التوصية.", "A clinical note explaining the decision is required."),
