...
STAGES = [
    ...
    {"label_ar": "تجهيز نتائج المختص", "label_en": "Preparing specialist results", "component": "Evidence mapping"},
]
    ...
    for sample in samples:
        for key, value in sample["results"].items():
            ...
            reasons.append({
                ...
                "text_ar": f"أبلغ نموذج «{ar}» عن إشارة في هذه العينة؛ راجع الدرجة والحد والتسجيل.",
