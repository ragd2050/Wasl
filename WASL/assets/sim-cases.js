    ...
    "WS-ST-001": {
      ...
      result: {
        ...
        proposed_plan: {
          ...
          treatment_note_ar: "اختيار المسار العلاجي (مثل برنامج ليدكمب) يقرّره المختص بعد التقييم الكامل.",
        ...
        guardian_message_ar: "تشير نتائج التقييم الأولي إلى وجود مؤشرات على صعوبة في طلاقة الكلام تستدعي مراجعة مختص. اعتمد المختص الخطوة التالية المناسبة، ولا يمثّل ذلك تشخيصًا نهائيًا.",
    ...
    "WS-ST-020": {
      ...
      result: {
        ...
        proposed_plan: {
          ...
          treatment_note_ar: "اختيار المسار العلاجي يقرّره المختص بعد التقييم الكامل؛ يُوصى بعدم التأخير.",
        ...
        guardian_message_ar: "تشير نتائج التقييم الأولي إلى مؤشرات واضحة على صعوبة في طلاقة الكلام تستدعي مراجعة مختص بأولوية عاجلة. اعتمد المختص الخطوة التالية، ولا يمثّل ذلك تشخيصًا نهائيًا.",
